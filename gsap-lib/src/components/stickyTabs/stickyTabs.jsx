  ...
  <div class="demo-nav">
    <div class="container">
      <div class="demo-nav__content">
        <svg class="demo-nav__logo-svg" xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 178 40" fill="none">
    ...
    <section class="sticky-tab">
      ...
      <div class="container">
        <div class="sticky-tab__placeholder-content">
          <svg class="osmo-icon-svg" xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 160 160" fill="none">
